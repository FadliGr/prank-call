...
echo -e  "Tools    : LoolZeck $white         " |lolcat
echo -e  "Creadby  : MrR $white   " |lolcat
echo -e  "Contact  : fadliblod00@gmail.com $white " |lolcat
echo -e  "Blog     : androprojek.blogspot.com " |lolcat
echo -e  "_____________________________________________________________"
...
6) echo "created by : LoolZeck" | lolcat
exit
;;
